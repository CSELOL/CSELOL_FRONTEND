      ...
      <div className="container max-w-6xl px-4 mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            Tem dúvidas sobre o torneio, quer ser um parceiro ou precisa de
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="h-12 w-12 rounded-lg bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-primary hover:border-primary transition-all"
                >
                  <Twitter className="h-5 w-5" />
                </a>
                <a
                  href="#"
                  className="h-12 w-12 rounded-lg bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-purple-600 hover:border-purple-600 transition-all"
                >
                  <Twitch className="h-5 w-5" />
                </a>
                <a
                  href="#"
                  className="h-12 w-12 rounded-lg bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-pink-600 hover:border-pink-600 transition-all"
                >
                ...
                <Select>
                  ...
                  <SelectContent className="bg-zinc-900 border-white/10 text-white">
                    ...
                    <SelectItem value="support">
                      Dúvidas sobre o Torneio
                    </SelectItem>
                    <SelectItem value="inscription">
                      Problemas com Inscrição
                    </SelectItem>
