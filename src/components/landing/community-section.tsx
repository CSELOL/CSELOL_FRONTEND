        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg text-zinc-400 max-w-xl mx-auto lg:mx-0">
              The tournament doesn't end when the nexus explodes. Join the
              largest League of Legends community in Sergipe. Find scrims, get
              live bracket updates, and trash talk (respectfully).
            </p>
            ...
            <Card className="bg-[#E1306C]/10 border-[#E1306C]/20 hover:bg-[#E1306C]/20 transition-colors cursor-pointer group">
              <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-[#E1306C]">
                    Bastidores e Highlights
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-[#9146FF]">
